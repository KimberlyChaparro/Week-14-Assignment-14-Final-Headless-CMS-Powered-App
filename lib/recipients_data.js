...
const dataURL = "https://dev-cs55-13-kc-test-site.pantheonsite.io/wp-json/twentytwentythree-child/v1/recipients";
...
export async function getSortedRecipientsList() {
  // get filepath to json file
  // const filePath = path.join(dataDir, 'persons.json');
...
//function returns names and ids for all json objects in array, sorted by name property
export async function getNewSortedContactsList() {
  // get filepath to json file
  // const filePath = path.join(dataDir, 'persons.json');
