...
import { getNewAllIds, getNewData } from '../../../lib/products_data';
...
export default function RecipientInfo({ itemData }) {
  return (
    <Layout>
      <article className="card col-12 margin-auto">
        <div className="card-body">
          <h5>Product Post Content</h5>
